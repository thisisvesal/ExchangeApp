...
public class Auth {
    ...
    public static boolean isCaptchaValid(String input) {
        if (currentCaptchaText.compareTo(input) == 0) {
            return true;
        }
        return false;
    }

    public static boolean[] isInfoValid(String username, String password, String repeatPassword, String email,
            String phoneNumber, String captchaInput) {
        // sw={phoneNumber,email,username,password}
        boolean[] invalid = { false, false, false, false, false };
    ...
    public static void setCurrentCaptchaText(String currentCaptchaText) {
        Auth.currentCaptchaText = currentCaptchaText;
    }
}
